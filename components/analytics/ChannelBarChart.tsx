  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-6 shadow-sm">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h3 className="text-base font-semibold text-slate-900 dark:text-white">Channel Performance</h3>
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-0.5">Leads and conversions by channel</p>
        </div>
      ...
      <ResponsiveContainer width="100%" height={300}>
        <BarChart data={channelPerformance} margin={{ top: 5, right: 10, left: 0, bottom: 5 }} barGap={4}>
          ...
          <Bar dataKey="conversions" fill="#a78bfa" radius={[4, 4, 0, 0]} />
        </BarChart>
      </ResponsiveContainer>
    </div>
  );
